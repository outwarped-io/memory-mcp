...
from memory_mcp_schemas.provenance import MemLineageRequest, MemSourcesBrowseRequest
from memory_mcp_schemas.relations import RelationBrowseRequest
from memory_mcp_schemas.tasks import TaskCreateRequest, TaskListRequest, TaskResponse
from pydantic import ValidationError

from memory_mcp import entities as entities_api
from memory_mcp import env_resolve
from memory_mcp import graph as graph_api
from memory_mcp import provenance as provenance_api
...
async def _invoke_digest(
    request: DigestRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
    ...
    async def fake_summarize(**_kwargs: Any):
        return (
            digest_api.DigestSections(brief="brief", active_context="context"),
            "template",
            SimpleNamespace(value="digest_template"),
        )
    ...
    return await digest_api.digest_for_env(
        request.env_id, since_ts=request.since_ts, ctx=_ctx(attached=attached), settings=SimpleNamespace()
    )


async def _invoke_resume(
    request: ResumeRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
    _patch_attached_rbac(monkeypatch, digest_api)
    ...
    return await digest_api.resume_for_env(
        request.env_id, journal_tail=request.journal_tail, ctx=_ctx(attached=attached)
    )


async def _invoke_dream_run(
    request: DreamRunRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
...
async def _invoke_dream_status(
    request: DreamStatusRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
    _patch_attached_rbac(monkeypatch, dream_api)
...
async def _invoke_dream_proposals(
    request: DreamProposalsListRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
    _patch_attached_rbac(monkeypatch, dream_api)
...
async def _invoke_entity_browse(
    request: EntityBrowseRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
...
async def _invoke_entity_neighbors(
    request: EntityNeighborsRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
...
async def _invoke_env_delete(
    request: EnvDeleteRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
...
async def _invoke_env_export(
    request: EnvExportRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
...
async def _invoke_env_rename(
    request: EnvRenameRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
...
async def _invoke_env_snapshot(
    request: EnvSnapshotRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
...
async def _invoke_mem_lineage(
    request: MemLineageRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
...
async def _invoke_mem_neighbors(
    request: MemNeighborsRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
    _patch_attached_rbac(monkeypatch, graph_api)
    monkeypatch.setattr(
        graph_api,
...
async def _invoke_mem_related(
    request: MemRelatedRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
    _patch_attached_rbac(monkeypatch, graph_api)
    ...
    return await graph_api.memory_related(
        request, ctx=_ctx(attached=attached), settings=SimpleNamespace(), vector_store=None
    )


async def _invoke_mem_sources(
    request: MemSourcesBrowseRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
    _patch_attached_rbac(monkeypatch, provenance_api)
...
async def _invoke_relation_browse(
    request: RelationBrowseRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
...
async def _invoke_task_create(
    request: TaskCreateRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
...
async def _invoke_task_list(
    request: TaskListRequest, monkeypatch: pytest.MonkeyPatch, *, attached: bool, deleted: bool = False
) -> Any:
    _patch_attached_rbac(monkeypatch, tasks_api)
...
CASES = [
    Wave2Case(
        "DigestRequest",
        lambda env_id=None, env_name=None: DigestRequest(env_id=env_id, env_name=env_name),
        _invoke_digest,
    ),
    Wave2Case(
        "ResumeRequest",
        lambda env_id=None, env_name=None: ResumeRequest(env_id=env_id, env_name=env_name),
        _invoke_resume,
    ),
    Wave2Case(
        "DreamRunRequest",
        lambda env_id=None, env_name=None: DreamRunRequest(
            env_id=env_id, env_name=env_name, modes=[DreamMode.decay], wait=True
        ),
        _invoke_dream_run,
    ),
    Wave2Case(
        "DreamStatusRequest",
        lambda env_id=None, env_name=None: DreamStatusRequest(env_id=env_id, env_name=env_name),
        _invoke_dream_status,
    ),
    Wave2Case(
        "DreamProposalsListRequest",
        lambda env_id=None, env_name=None: DreamProposalsListRequest(env_id=env_id, env_name=env_name),
        _invoke_dream_proposals,
    ),
    Wave2Case(
        "EntityBrowseRequest",
        lambda env_id=None, env_name=None: EntityBrowseRequest(
            env_ids=[env_id] if env_id else None, env_names=[env_name] if env_name else None
        ),
        _invoke_entity_browse,
        plural=True,
    ),
    Wave2Case(
        "EntityNeighborsRequest",
        lambda env_id=None, env_name=None: EntityNeighborsRequest(
            entity_id=ENTITY_ID, env_id=env_id, env_name=env_name
        ),
        _invoke_entity_neighbors,
    ),
    Wave2Case(
        "EnvDeleteRequest",
        lambda env_id=None, env_name=None: EnvDeleteRequest(env_id=env_id, env_name=env_name, confirm_destroy=True),
        _invoke_env_delete,
        allow_deleted=True,
    ),
    Wave2Case(
        "EnvExportRequest",
        lambda env_id=None, env_name=None: EnvExportRequest(
            env_id=env_id, env_name=env_name, format=ExportFormat.directory, target_path=str(SCRATCH / "export-target")
        ),
        _invoke_env_export,
        allow_deleted=True,
    ),
    Wave2Case(
        "EnvRenameRequest",
        lambda env_id=None, env_name=None: EnvRenameRequest(env_id=env_id, env_name=env_name, new_name="renamed-env"),
        _invoke_env_rename,
        allow_deleted=True,
    ),
    Wave2Case(
        "EnvSnapshotRequest",
        lambda env_id=None, env_name=None: EnvSnapshotRequest(env_id=env_id, env_name=env_name, label="snapshot"),
        _invoke_env_snapshot,
        allow_deleted=True,
    ),
    Wave2Case(
        "MemLineageRequest",
        lambda env_id=None, env_name=None: MemLineageRequest(memory_id=MEMORY_ID, env_id=env_id, env_name=env_name),
        _invoke_mem_lineage,
        allow_deleted=True,
    ),
    Wave2Case(
        "MemNeighborsRequest",
        lambda env_id=None, env_name=None: MemNeighborsRequest(memory_id=MEMORY_ID, env_id=env_id, env_name=env_name),
        _invoke_mem_neighbors,
    ),
    Wave2Case(
        "MemRelatedRequest",
        lambda env_id=None, env_name=None: MemRelatedRequest(memory_id=MEMORY_ID, env_id=env_id, env_name=env_name),
        _invoke_mem_related,
    ),
    Wave2Case(
        "MemSourcesBrowseRequest",
        lambda env_id=None, env_name=None: MemSourcesBrowseRequest(
            env_ids=[env_id] if env_id else None, env_names=[env_name] if env_name else None
        ),
        _invoke_mem_sources,
        plural=True,
    ...
    Wave2Case(
        ...
        lambda env_id=None, env_name=None: RelationBrowseRequest(
            env_ids=[env_id] if env_id else None, env_names=[env_name] if env_name else None
        ),
        _invoke_relation_browse,
        plural=True,
    ),
    Wave2Case(
        "TaskCreateRequest",
        lambda env_id=None, env_name=None: TaskCreateRequest(env_id=env_id, env_name=env_name, title="task"),
        _invoke_task_create,
    ),
    Wave2Case(
        "TaskListRequest",
        lambda env_id=None, env_name=None: TaskListRequest(env_id=env_id, env_name=env_name),
        _invoke_task_list,
    ),
]
